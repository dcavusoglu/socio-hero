...
import bottleImage from '../../assets/bottle.jpeg'
...
const Cocktail = () => {
  ...
  useEffect(() => {
    axios.get(`${cocktailUrl}?i=${id}`).then(
      (response) => {
  ...
  //         console.log(item);
  //         axios.get(`${ingredientUrl}${item}-Medium.png`).then(
  //           res => {
  //             console.log('pic',res);
  //             picList.push(res);
  //           }
  ...
  //   }
    ...
    return (
      ...
      <div className='flex flex-col items-end mt-2'>
        <img src={shareBtn} alt='share' className='w-6 mr-4'/>
      </div>
      {cocktail ? (
        <div>
          <div className='flex flex-col-reverse items-center md:flex-row md:justify-around lg:justify-around mt-6'>
            ...
            <div className='flex flex-row'>
              <img src={cocktail.strDrinkThumb ? cocktail.strDrinkThumb : drinkImage} alt='drink' className='w-48 h-48 rounded-xl'/>
            </div>
          </div>
          <div>
          ...
          <div className='flex flex-row justify-center mt-6'>
            ...
            */}
            {/* {ingredients?.map(item => {
              <img src={`${ingredientUrl}${item}-Medium.png`} alt='bottle' className='w-28 h-36 rounded-xl'/>
            })} */}

              <img src={`${ingredientUrl}${cocktail.strIngredient1}-Medium.png`} alt='bottle' className='w-28 h-36 rounded-xl'/>
              <img src={`${ingredientUrl}${cocktail.strIngredient2}-Medium.png`} alt='bottle' className='w-28 h-36 rounded-xl'/>
              {(cocktail.strIngredient3) ?
                <img src={`${ingredientUrl}${cocktail.strIngredient3}-Medium.png`} alt='bottle' className='w-28 h-36 rounded-xl'/> : ""
              }
              {(cocktail.strIngredient4) ?
              <img src={`${ingredientUrl}${cocktail.strIngredient4}-Medium.png`} alt='bottle' className='w-28 h-36 rounded-xl'/> : ""
            }
              {(cocktail.strIngredient5) ?
              <img src={`${ingredientUrl}${cocktail.strIngredient5}-Medium.png`} alt='bottle' className='w-28 h-36 rounded-xl'/> : ""
            }
